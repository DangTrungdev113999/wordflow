    ...
    <div className="px-4 py-6 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Irregular Verbs</h1>
      ...
      >
        <LegendDot color="bg-emerald-500" label="AAA — cut-cut-cut" />
        <LegendDot color="bg-blue-500" label="ABB — buy-bought-bought" />
        <LegendDot color="bg-violet-500" label="ABC — go-went-gone" />
        <LegendDot color="bg-amber-500" label="ABA — come-came-come" />
      </motion.div>
