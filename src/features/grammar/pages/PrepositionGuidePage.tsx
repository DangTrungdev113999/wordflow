...
export function PrepositionGuidePage() {
  return (
    <div className="px-4 py-6 max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-white">Prepositions</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Hướng dẫn giới từ: in/on/at theo thời gian, nơi chốn, chuyển động
            </p>
          </div>
        </div>
      </motion.div>
