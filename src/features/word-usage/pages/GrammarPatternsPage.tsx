    ...
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">{GRAMMAR_PATTERNS.length} mẫu ngữ pháp</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        {filtered.length === 0 && (
          <p className="text-center text-sm text-gray-600 dark:text-gray-400 py-8">Không tìm thấy grammar pattern nào</p>
        )}
      </div>
    </div>
  );
