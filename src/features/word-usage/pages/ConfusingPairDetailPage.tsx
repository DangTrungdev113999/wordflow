...
export function ConfusingPairDetailPage() {
  ...
  if (!pair) {
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        <p className="text-gray-600 dark:text-gray-400">Không tìm thấy cặp từ này</p>
        <button
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      {related.length > 0 && (
        <div className="pt-2">
          <p className="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide font-medium mb-2">Cặp từ liên quan</p>
