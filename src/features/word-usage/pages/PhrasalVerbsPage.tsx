    ...
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-600 dark:text-gray-400">{PHRASAL_VERBS.length} cụm động từ</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        {filtered.length === 0 && (
          <p className="text-center text-sm text-gray-600 dark:text-gray-400 py-8">Không tìm thấy phrasal verb nào</p>
        )}
      </div>
    </div>
  );
